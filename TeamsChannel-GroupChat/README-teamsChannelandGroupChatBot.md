# TeamsChannelandGroupChat - `teamsChannelandGroupChatBot`
...
3. Give the bot a handle (ex: `teamsChannelandGroupChatBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://msteamchannelgroupchat.azurewebsites.net/api/messages`

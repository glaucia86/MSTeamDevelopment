# InteractiveChatBot Bot - `interactiveChatBotBot`
...
3. Give the bot a handle (ex: `interactiveChatBotBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://interactivechatbot.azurewebsites.net/api/messages`
